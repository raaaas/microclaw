...
| `clawhub_registry` | `String` | `default_clawhub_registry` | `"https://clawhub.ai".into()` |
| `clawhub_token` | `Option<String>` | `serde(default)` | `null` |
| `clawhub_agent_tools_enabled` | `bool` | `default_true` | `true` |
| `clawhub_skip_security_warnings` | `bool` | `serde(default)` | `false` |
